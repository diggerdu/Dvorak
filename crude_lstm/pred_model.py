...
class Predictor():
	def __init__(self):
		saver = tf.train.import_meta_graph('./checkpoint/extraoridinary.ckpt.meta')
		self.sess = tf.Session()
		saver.restore(self.sess, "./checkpoint/extraoridinary.ckpt")
		self.pred = self.sess.graph.get_operation_by_name('Round').outputs[0]
...
if __name__ == '__main__':
	...
	print (p.predict(np.zeros((15360,))))
