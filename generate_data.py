...
eva_labels_idx, eva_labels_val, eva_labels_shape = sparse_tuple_from(eva_label)
np.save(output_path + "eva_labels_idx", eva_labels_idx)
np.save(output_path + "eva_labels_val", eva_labels_val)
np.save(output_path + "eva_labels_shape", eva_labels_shape)

del eva_data, eva_labels_idx, eva_labels_val, eva_labels_shape
'''
